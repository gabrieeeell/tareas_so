...
main(int argc, char *argv[])
{
  ...
  if (argc < 3) {
   8:	4709                	li	a4,2
   a:	00a74f63          	blt	a4,a0,28 <main+0x28>
   e:	ec26                	sd	s1,24(sp)
  10:	e84a                	sd	s2,16(sp)
  12:	e44e                	sd	s3,8(sp)
  14:	e052                	sd	s4,0(sp)
  ...
  1a:	8da50513          	addi	a0,a0,-1830 # 8f0 <malloc+0x104>
  1e:	71a000ef          	jal	738 <printf>
    exit(1);
  22:	4505                	li	a0,1
  24:	2e4000ef          	jal	308 <exit>
  28:	ec26                	sd	s1,24(sp)
  2a:	e84a                	sd	s2,16(sp)
  2c:	e44e                	sd	s3,8(sp)
  2e:	e052                	sd	s4,0(sp)
  ...
  40:	fd490913          	addi	s2,s2,-44 # 1010 <archivo_actual>
         sizeof(archivo_actual)) {

    printf("%s\n", archivo_actual.name);
  44:	00001a17          	auipc	s4,0x1
  48:	fcea0a13          	addi	s4,s4,-50 # 1012 <archivo_actual+0x2>
  4c:	00001997          	auipc	s3,0x1
  50:	8cc98993          	addi	s3,s3,-1844 # 918 <malloc+0x12c>
  while (read(file_descriptor, &archivo_actual, sizeof(archivo_actual)) ==
  54:	a029                	j	5e <main+0x5e>
    printf("%s\n", archivo_actual.name);
  56:	85d2                	mv	a1,s4
  58:	854e                	mv	a0,s3
  5a:	6de000ef          	jal	738 <printf>
  while (read(file_descriptor, &archivo_actual, sizeof(archivo_actual)) ==
  5e:	4641                	li	a2,16
  60:	85ca                	mv	a1,s2
  62:	8526                	mv	a0,s1
  64:	2bc000ef          	jal	320 <read>
  68:	47c1                	li	a5,16
  6a:	fef506e3          	beq	a0,a5,56 <main+0x56>
  }
